    ...
    static void Main(string[] args)
    {
        ...
        while (position < input.Length)
        {
            if (enabled)
            {
                ...
                {
                    case "mul":
                        if (input.Length - position > 7 && input.Substring(position, 7) == "don't()")
                        {
                            enabled = false;
                            position += 7;
                        }
                        else if (input.Length - position > 3 && input.Substring(position, 3) == "mul")
                        {
                            position += 3;
                            lookingFor = "(";
                        }
            ...
            {
                if (input.Length - position > 4 && input.Substring(position, 4) == "do()")
                {
                    enabled = true;
                    position += 4;
                }
